                    ...
                    for (i in classtime_name1) {
                        if (week == classtime_name1[i]) {
                            ...
                            for (j in classtime_name2) {
                                ...
                                chtml += `<div id="clt"><div id="text1"><a id="clt1">${Number(j)+1}교시 </a><a id="clt2">${cltxt}</a></div><div id="text2"><a id="clt3" href="#" onclick="gozoom('${zoomidtxt}')">${zoomidtxt}</a></div></div>`;
                            }
                        }
                    }
                    $(`#zoom`).html(chtml);
